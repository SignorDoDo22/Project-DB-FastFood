...
public class CreateIngrediente extends JDialog {
    ...
    public CreateIngrediente(ControllerAdmin controller) {
        ...
        creaIngredienteButton.addActionListener(e -> {
            ...
            if (this.controller.createIngrediente(dataIngrediente.get(nomeIngrediente).getText(),
                    ingredientiPresentiCheckBox)) {
                JOptionPane.showMessageDialog(this, "Ingrediente creato con successo!", "Successo",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Errore nella creazione dell'ingrediente. Potrebbe già esistere.",
