...
public class InformazioniAggregate {
    ...
    public static class DAO{
        ...
        public static Map<Pair<String,String>,Pair<Float,Integer>> getClassificaMiglioriRider(Connection connection) {

            try (PreparedStatement preparedStatement = DAOUtils.prepare(connection, Queries.CLASSIFICA_MIGLIORI_RIDER.get());
                 ResultSet resultSet = preparedStatement.executeQuery()) {
        ...
        public static Map<Pair<String,String>,Pair<Integer,Integer>> getRecensioniNegative(Connection connection) {
            try (PreparedStatement preparedStatement = DAOUtils.prepare(connection, Queries.MOSTRA_RECENSIONI_NEGATIVE.get());
                 ResultSet resultSet = preparedStatement.executeQuery()) {
