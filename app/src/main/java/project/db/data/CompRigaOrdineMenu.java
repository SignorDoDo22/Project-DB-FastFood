...
public class CompRigaOrdineMenu {
    ...
    public static class DAO {
        ...
        public static boolean insertRigaOrdineMenu(Connection connection, int numeroRiga, String codiceOrdine, String codiceRiga, String codiceProdotto) {
            try (PreparedStatement preparedStatement = DAOUtils.prepare(connection, Queries.INSERIRE_COMPONENTE_MENU_ORDINATO.get())) {
        ...
        public static boolean insertModificaCompMenu(Connection connection, String Codice_Ordine, String Codice_Riga, int NumRowCompMenu, String CodiceIngrediente, int quantita, String tipo) {
            try (PreparedStatement preparedStatement = DAOUtils.prepare(connection, Queries.INSERIRE_MODIFICA_COMPONENTE_MENU.get())) {
                ...
                preparedStatement.setString(4, CodiceIngrediente);
